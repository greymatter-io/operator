...
// out here: We need to be able to unify a new defaults.redis_spire_subjects and re-apply this listener.
redis_listener: #listener & {
    ...
    if flags.spire {
      secret: #spire_secret & {
        _name: Name
        _subjects: defaults.redis_spire_subjects
      }
    }
  },
