...
// All known versions are lists of OCI image strings with an optional
...
Versions: {
  if mesh.spec.release_version == "latest" {
    ...
    control_api: *"docker.greymatter.io/development/gm-control-api:latest" | mesh.spec.images.control
    ...
    jwtsecurity: *"docker.greymatter.io/development/gm-jwt-security:latest" | mesh.spec.images.jwt_security
    redis: *"bitnami/redis:5.0.12" | mesh.spec.images.redis
    prometheus: *"prom/prometheus:v2.7.1" | mesh.spec.image.prometheus
  }
  ...
  if mesh.spec.release_version == "1.7" {
    ...
    control_api: *"docker.greymatter.io/release/gm-control-api:1.7.0-rc.3" | mesh.spec.images.control
    ...
    jwtsecurity: *"docker.greymatter.io/release/gm-jwt-security:1.3.0" | mesh.spec.images.jwt_security
    redis: *"bitnami/redis:5.0.12" | mesh.spec.images.redis
    prometheus: *"prom/prometheus:v2.7.1" | mesh.spec.images.redis
  }
  ...
  if mesh.spec.release_version == "1.6" {
    ...
    control_api: *"docker.greymatter.io/release/gm-control-api:1.6.5" | mesh.spec.images.control
