...
func (i *Installer) ApplyMesh(mesh *v1alpha1.Mesh) {
...
INSTALL_LOOP:
	for _, group := range manifests {
		...
		controllerutil.CreateOrUpdate(context.TODO(), i.client, group.Deployment, func() error { return nil })
		for _, service := range group.Services {
			controllerutil.SetOwnerReference(mesh, service, scheme)
			controllerutil.CreateOrUpdate(context.TODO(), i.client, service, func() error { return nil })
		}
	}
}
