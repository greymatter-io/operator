...
# $(IMAGE_TAG_BASE)-bundle:$VERSION and $(IMAGE_TAG_BASE)-catalog:$VERSION.
IMAGE_TAG_BASE ?= docker.greymatter.io/development/gm-operator
...
test: fmt generate manifests vet envtest ## Run tests.
