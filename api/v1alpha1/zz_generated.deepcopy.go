...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemValues) DeepCopyInto(out *SystemValues) {
	*out = *in
	in.Proxy.DeepCopyInto(&out.Proxy)
	in.Edge.DeepCopyInto(&out.Edge)
	in.Control.DeepCopyInto(&out.Control)
	in.ControlAPI.DeepCopyInto(&out.ControlAPI)
	in.Catalog.DeepCopyInto(&out.Catalog)
	in.Dashboard.DeepCopyInto(&out.Dashboard)
	in.JWTSecurity.DeepCopyInto(&out.JWTSecurity)
	in.Redis.DeepCopyInto(&out.Redis)
	in.Prometheus.DeepCopyInto(&out.Prometheus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemValues.
func (in *SystemValues) DeepCopy() *SystemValues {
	if in == nil {
		return nil
	}
	out := new(SystemValues)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemValuesConfig) DeepCopyInto(out *SystemValuesConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.SystemValues.DeepCopyInto(&out.SystemValues)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemValuesConfig.
func (in *SystemValuesConfig) DeepCopy() *SystemValuesConfig {
	if in == nil {
		return nil
	}
	out := new(SystemValuesConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SystemValuesConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemValuesConfigList) DeepCopyInto(out *SystemValuesConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]SystemValuesConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemValuesConfigList.
func (in *SystemValuesConfigList) DeepCopy() *SystemValuesConfigList {
	if in == nil {
		return nil
	}
	out := new(SystemValuesConfigList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SystemValuesConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
